...
#include <stdio.h>
#include <stdlib.h> //no le pasamos la ruta, esta en el sist operativo . en el sist operativo estan las bibliotecas estandar del lenguaje

#include "arr.h"// en el include le esta dando la ruta del sistema del archivo. El nombre es el mismo de las bibliotecas.
