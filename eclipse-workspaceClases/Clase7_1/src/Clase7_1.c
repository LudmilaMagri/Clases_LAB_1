...
int main(void) {
	...
	int j;
	//int numeros [4];
	char texto[7]= {72, 'B', 'C',0, 'D', 'X', 0}; // COMILLA SIMPLE, se usa char por el tamaño de memoria que es menor. utilizo 0 sin comillas porque es un numero invisible, en acii es invisible, no me lo traduce con ninguna letra.
